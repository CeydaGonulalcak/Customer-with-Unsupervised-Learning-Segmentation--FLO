...
###############################################################
# TASK 1: Read the data set and select the variables you will use when segmenting customers.
###############################################################
...
final_df.groupby("segment_hierarchical").agg({"order_num_total_ever_online":["mean","min","max"],
                                  "order_num_total_ever_offline":["mean","min","max"],
                                  "customer_value_total_ever_offline":["mean","min","max"],
                                  "customer_value_total_ever_online":["mean","min","max"],
                                  "recency":["mean","min","max"],
